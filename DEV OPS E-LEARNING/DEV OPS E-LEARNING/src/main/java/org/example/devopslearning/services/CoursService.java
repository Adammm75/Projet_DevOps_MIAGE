...
public class CoursService {
    ...
    public void deleteCourse(Long id) {
        ...
        List<CourseRessource> resources = ressourceCoursRepository.findByCourse(cours);
     ...
     */
    @Transactional
    public CourseRessource addResourceToCourse(Long courseId, String originalName, String fileUrl) {
     ...
     */
    public List<CourseRessource> getResourcesByCourse(Long courseId) {
        Cours cours = getById(courseId);
     ...
     */
    public List<CourseRessource> getResources(Long courseId) {
     ...
     */
    public CourseRessource getResourceById(Long id) {
    ...
    public Long getCourseIdByResource(Long resourceId) {
        CourseRessource resource = getResourceById(resourceId);
