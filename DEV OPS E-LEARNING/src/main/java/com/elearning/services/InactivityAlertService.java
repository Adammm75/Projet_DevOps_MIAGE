...
import com.elearning.repositories.InactivityAlertRepository;
...
public class InactivityAlertService {
    ...
    */
    ...
    public void runInactivityCheck(int daysThreshold) {
        List<User> students = userRepository.findAllByUserRoles_Name("ROLE_STUDENT");
        ...
        for (User student : students) {
            ...
            for (Cours course : courses) {
                ...
                List<com.elearning.activity.StudentActivity> acts = activityRepository.findByStudentAndCourseOrderByActivityTimeDesc(studentId, courseId);


                LocalDateTime lastActivity = acts.isEmpty() ? null : acts.get(0).getActivityTime();
