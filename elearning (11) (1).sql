...
--
-- Hôte : mysql:3306
-- Généré le : mar. 24 fév. 2026 à 17:54
...
(1006, 8912585819139254770, 'tp1', 'tp1a', '2026-03-03 22:59:00', 20.00, 22, '2026-02-24 09:02:18'),
(1007, 8912585819139254771, 'TP1 mpac1', 'td', '2026-03-03 22:59:00', 20.00, 22, '2026-02-24 12:59:55');
...
(11, 1006, 4, '2026-02-24 09:02:18'),
(12, 1007, 4, '2026-02-24 12:59:55');
...
(9, 1006, 21, '2026-02-24 09:03:11', 'https://elearning-miage-adam.s3.eu-north-1.amazonaws.com/assignments/9dab5e04-f67c-4df5-a14a-d425d28c1656_MTH.pdf', 18.00, 'très bien', '2026-02-24 09:04:25', 22),
(10, 1005, 21, '2026-02-24 09:57:49', 'https://elearning-miage-adam.s3.eu-north-1.amazonaws.com/assignments/98c102e9-2fc8-42f1-9179-9113441befb0_MTH.pdf', NULL, NULL, NULL, NULL),
(11, 1007, 21, '2026-02-24 13:00:32', 'https://elearning-miage-adam.s3.eu-north-1.amazonaws.com/assignments/a95b45c0-739b-407e-ad28-b2c07bbe0262_MTH.pdf', 15.00, 'bien', '2026-02-24 13:01:27', 22);
...
(8912585819139254771, 'MAPC1', 'MAPC1', 'MAPC', 22, '2026-02-24 12:58:52', NULL),
(8912585819139254772, 'ssssss', 'sssss', 'ssssssss', 22, '2026-02-24 14:26:47', NULL);
...
CREATE TABLE `course_resources` (
  ...
  `s3_audio_url` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `structure_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
(3, 8912585819139254771, 'FILE', 'BDA', 'BDA', 'https://elearning-miage-adam.s3.eu-north-1.amazonaws.com/uploads/other/0c4fc62c-2abc-41fb-a802-da876c889f54_elearning (8).sql', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-24 12:59:28', '2026-02-24 12:59:28'),
(4, 8912585819139254772, 'FILE', 'message (7).txt', NULL, 'https://elearning-miage-adam.s3.eu-north-1.amazonaws.com/uploads/f97ddd80-811d-4be9-9721-d529f09d1472_message (7).txt', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-24 14:26:48', NULL),
(5, 8912585819139254772, 'FILE', 'eee', 'eeeee', 'https://elearning-miage-adam.s3.eu-north-1.amazonaws.com/uploads/presentations/4316c1ad-7428-4b39-b4ca-4c2187a06a36_chapitre introductif.ppt', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-24 14:28:59', '2026-02-24 14:28:59');
...
(37, 4, 23, '2026-02-24 12:57:08', 'ACTIF');
...
(9, 21, 3, NULL, 'test', 'test', '2026-02-24 09:00:59', 0),
(10, 23, 3, NULL, 'test', 'test', '2026-02-24 12:57:48', 0);
...
(28, 8912585819139254770, 21, 18.00, 20.00, 'TB', 'VALIDE', '2026-02-24 09:35:24', '2026-02-24 09:35:24'),
(29, 8912585819139254771, 21, 15.00, 20.00, 'B', 'VALIDE', '2026-02-24 13:03:26', '2026-02-24 13:03:26');
...
(2004, 8912585819139254770, 'bda1', 'bda1', 8, 1, 1, 22, '2026-02-24 09:40:38');
...
(33, 2111, 'tttttttttt', 'tttttttttt', 0, 0),
(34, 2111, 'f', 'f', 0, 0),
(35, 2111, 'gggggggg', 'gggggggg', 1, 0),
(36, 2111, 'gb', 'gb', 0, 0);
...
(2111, 2004, 'test', 'test', 'CHOIX_SIMPLE', 'CHOIX_SIMPLE', 1.00, 1, 1);
...
--
-- Structure de la table `resource_consultations`
--
...
--
-- Déchargement des données de la table `resource_consultations`
--

INSERT INTO `resource_consultations` (`id`, `resource_id`, `student_id`, `consulted_at`, `last_seen_at`, `view_count`) VALUES
(1, 4, 21, '2026-02-24 15:32:23', '2026-02-24 15:32:23', 1),
(2, 5, 21, '2026-02-24 15:33:24', '2026-02-24 15:33:24', 1);
...
(23, 'dddd@gmail.com', '$2a$10$f50jHS7JKud7B2YbDV0CSepAkixY1ENC5hWgBediYgZiia0HKJXxe', 'ddddd', 'dddd', '2026-02-24 12:55:54', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `user_course_completion`
--
...
--
-- Déchargement des données de la table `user_course_completion`
--

INSERT INTO `user_course_completion` (`id`, `user_id`, `course_id`, `is_completed`, `completed_at`, `updated_at`) VALUES
(1, 21, 4, 1, '2026-02-24 16:36:05', '2026-02-24 16:36:05'),
(2, 21, 8912585819139254772, 1, '2026-02-24 16:39:49', '2026-02-24 16:39:49');
...
--
-- Index pour la table `resource_consultations`
--
ALTER TABLE `resource_consultations`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_resource_student` (`resource_id`,`student_id`),
...
--
-- Index pour la table `user_course_completion`
--
...
--
ALTER TABLE `assignments`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1008;
...
--
ALTER TABLE `courses`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8912585819139254773;
...
--
ALTER TABLE `qcms`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2005;
...
--
ALTER TABLE `qcm_questions`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2112;
...
--
-- AUTO_INCREMENT pour la table `resource_consultations`
--
ALTER TABLE `resource_consultations`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT pour la table `user_course_completion`
--
ALTER TABLE `user_course_completion`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Contraintes pour la table `resource_consultations`
--
ALTER TABLE `resource_consultations`
  ADD CONSTRAINT `resource_consultations_ibfk_1` FOREIGN KEY (`resource_id`) REFERENCES `course_resources` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `resource_consultations_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
--
-- Contraintes pour la table `user_course_completion`
--
ALTER TABLE `user_course_completion`
  ADD CONSTRAINT `user_course_completion_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
